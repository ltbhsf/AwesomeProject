...
export default function EmerSituation({setLoginloc}) {
  ...
  return (
    <>
      <View className="flex-1">
        ...
        <ToggleContainer isEnabled={carIsEnabled} setIsEnabled={() => changeSetting("carIsEnabled")} what="차경적 소리" />
        <ToggleContainer isEnabled={sirenIsEnabled} setIsEnabled={() => changeSetting("sirenIsEnabled")} what="사이렌 소리" />
      </View>
      <ProgressButton
        onPressIn={() => {
          setLoginloc('emerkeyword');
        }}
        actiavted={true}
        text="다음"
      />
